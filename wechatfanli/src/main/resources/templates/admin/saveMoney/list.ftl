                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        ...
                        <div class="layui-card-header">
                          ...
                          <button class="layui-btn" onclick="xadmin.open('添加超级省钱活动','/cms/savemoney/add/dispatch',700,500)">添加</button>
                        </div>
                        <div class="layui-card-body ">
        ...
        layui.use(['table', 'form', 'layer', 'laydate'], function () {
            ...
            table.render({
                ...
                , cols: [[
                    ...
                    , {field: 'banner', title: 'banner图'}
                    , {field: 'link', title: '活动链接'}
                    , {field: 'status', title: '活动状态',templet: statusRender}
            ...
            table.on('tool(l-f-table)', function (obj) {
                ...
                if (layEvent === 'update') {
                    xadmin.open('修改配置', '/cms/savemoney/update/dispatch?id=' + data.id, 700, 500);
                }
