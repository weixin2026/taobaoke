...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="/static/m/css/cn666plus.css">
</head>
<body>
        ...
        <div class="app">
            ...
            <div class="next-nav2">
                <div class="box">
                    ...
                    <#list cateList as c>
                        <li><a class="<#if c.id == cate.id>active</#if>" href="/cate${c.fqcat!}/" title="${c.name!}">${c.name!}</a></li>
                    </#list>
                    </@category_list>
                    </ul>
                </div>
